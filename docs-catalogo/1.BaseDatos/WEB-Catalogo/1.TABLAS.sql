...
ALTER TABLE [dbo].[rol] ADD  CONSTRAINT [DF_ROL_USAURIO_CREA]  DEFAULT ((USER_NAME())) FOR [USUARIO_CREACION]
GO
...
ALTER TABLE [dbo].[user_catalogo] ADD  CONSTRAINT [FK_USUARIO_DIRECCION]  FOREIGN KEY (DIRECCION_ID) REFERENCES [dbo].[direccion]([ENUM_ID])
GO
...
ALTER TABLE [dbo].[user_catalogo] ADD  CONSTRAINT [DF_USUARIO_USAURIO_CREA]  DEFAULT ((USER_NAME())) FOR [USUARIO_CREACION]
GO
